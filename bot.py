...
# === PROMO PORUKE SA SLIKAMA (lepo formatirane) ===
PROMO_MESSAGES = [
    {
...
# === SLANJE PROMO PORUKA POSLE 30-45 SEKUNDI ===
async def send_promo_after_start(user_id):
    await asyncio.sleep(random.randint(7000, 8500))
    try:
...
# === FUNKCIJA ZA DEPOSIT (da ne dupliram kod) ===
...
async def main():
    print("✅ Bot je spreman sa komandama!")
